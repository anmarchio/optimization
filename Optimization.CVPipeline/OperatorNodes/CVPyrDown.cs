...
{
    [Serializable]
    public class CVPyrDown : CVNode
    {
        public CVPyrDown() : base()
        {

        }

        public CVPyrDown(List<CVNode> children, float[] parameters) : base(children, parameters)
        {
