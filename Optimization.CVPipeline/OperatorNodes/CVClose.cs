...
namespace Optimization.CVPipeline.OperatorNodes
{
    ...
    public class CVClose : CVNode
    {
        ...
        public CVClose(List<CVNode> children, float[] parameters) : base(children, parameters)
        {
        ...
        private System.Drawing.Point Anchor { get; set; } = new System.Drawing.Point(0, 0);
