...
namespace Optimization.CVPipeline.OperatorNodes
{
    ...
    public class CVErode : CVNode
    {
        ...
        public CVErode(List<CVNode> children, float[] parameters) : base(children, parameters)
        {
        ...
        {
            output = new UMat();
            CvInvoke.MorphologyEx(input, output, Emgu.CV.CvEnum.MorphOp.Erode, StructElement, Anchor, Iterations, Emgu.CV.CvEnum.BorderType.Default, new Emgu.CV.Structure.MCvScalar(0));
            return output;
        }
        ...
        {
            return new float[] { Iterations, /*(int) StructElementType,*/ ElementWidth, ElementHeight  };
        }
    }
}
