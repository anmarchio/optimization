...
{
    [Serializable]
    public class CVMorphologyOpen : CVNode
    {
        public CVMorphologyOpen() : base()
        {

        }

        public CVMorphologyOpen(List<CVNode> children, float[] parameters) : base(children, parameters)
        {
