...
{
    [Serializable]
    public class CVMorphologyErode : CVNode
    {
        public CVMorphologyErode() : base()
        {

        }

        public CVMorphologyErode(List<CVNode> children, float[] parameters) : base(children, parameters)
        {
