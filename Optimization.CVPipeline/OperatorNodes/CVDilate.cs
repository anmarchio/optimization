...
{
    [Serializable]
    public class CVDilate : CVNode
    {
        public CVDilate() : base()
        {

        }

        public CVDilate(List<CVNode> children, float[] parameters) : base(children, parameters)
        {
        ...
        {
            output = new UMat();
            CvInvoke.Dilate(input, output, StructElement, Anchor, Iterations, Emgu.CV.CvEnum.BorderType.Default, new Emgu.CV.Structure.MCvScalar(0));
            return output;
        }
        ...
        public override void FromCGPNodeParameters(float[] parameters)
        {
            ...
            //StructElementType = (Emgu.CV.CvEnum.ElementShape)parameters[1];
            ElementWidth = (int)parameters[2];
            ElementHeight = (int)parameters[2];
        }

        public override float[] ToCGPNodeParameters()
        {
            return new float[] { Iterations, /*(float)StructElementType,*/ ElementWidth, ElementHeight };
        }
    }
}
