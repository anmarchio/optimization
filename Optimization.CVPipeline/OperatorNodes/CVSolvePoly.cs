...
{
    [Serializable]
    public class CVSolvePoly : CVNode
    {
        public CVSolvePoly() : base()
        {

        }

        public CVSolvePoly(List<CVNode> children, float[] parameters) : base(children, parameters)
        {
        ...
        {
            output = new UMat();
            CvInvoke.SolvePoly(input, output);
            return output;
