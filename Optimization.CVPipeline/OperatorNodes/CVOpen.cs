...
namespace Optimization.CVPipeline.OperatorNodes
{
    ...
    public class CVOpen : CVNode
    {
        ...
        public CVOpen(List<CVNode> children, float[] parameters) : base(children, parameters)
        {
        ...
        {
            output = new UMat();
            CvInvoke.MorphologyEx(input, output, Emgu.CV.CvEnum.MorphOp.Open, StructElement, Anchor, Iterations, Emgu.CV.CvEnum.BorderType.Default, new Emgu.CV.Structure.MCvScalar(0));
            return output;
        }
