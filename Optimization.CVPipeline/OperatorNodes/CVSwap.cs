...
namespace Optimization.CVPipeline.OperatorNodes
{
    ...
    public class CVSwap : CVNode
    {
        ...
        public CVSwap(List<CVNode> children, float[] parameters) : base(children, parameters)
        {
        ...
        public override UMat Execute(UMat input)
        {
            ...
            //Swapping with itself not really useful
            //help = input.clone();
            CvInvoke.Swap(input, output);
            return output;
        }
