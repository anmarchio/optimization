...
{
    [Serializable]
    public class CVMorphologyBlackHat : CVNode
    {
        public CVMorphologyBlackHat() : base()
        {

        }

        public CVMorphologyBlackHat(List<CVNode> children, float[] parameters) : base(children, parameters)
        {
        ...
        {
            output = new UMat();
            CvInvoke.MorphologyEx(input, output, Emgu.CV.CvEnum.MorphOp.Blackhat, StructElement, Anchor, Iterations, Emgu.CV.CvEnum.BorderType.Default, new Emgu.CV.Structure.MCvScalar(0));
            return output;
        }
