...
{
    [Serializable]
    public class CVMorphologyGradient : CVNode
    {
        public CVMorphologyGradient() : base()
        {

        }

        public CVMorphologyGradient(List<CVNode> children, float[] parameters) : base(children, parameters)
        {
        ...
        {
            output = new UMat();
            CvInvoke.MorphologyEx(input, output, Emgu.CV.CvEnum.MorphOp.Gradient, StructElement, Anchor, Iterations, Emgu.CV.CvEnum.BorderType.Default, new Emgu.CV.Structure.MCvScalar(0));
            return output;
        }
